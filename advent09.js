...
are nestable. Your puzzle input represents a single, large group which 
...
const filter_cancelled_characters = function(s) {
  var f = [];
  var i = 0;
  while (i < s.length) {
    switch (s[i]) {
...
const filter_garbage = function(s) {
  var f = [];
  var i = 0;
  var garbage_removed = 0;
  while (i < s.length) {
    switch (s[i]) {
      case '<':
        i++;
