...
if the previous example was your first round, you would start your second 
round with the same length sequence (3, 4, 1, 5, 17, 31, 73, 47, 23, now 
assuming they came from ASCII codes and include the suffix), but start 
...
So, the first element in the dense hash is the first sixteen elements of the 
...
always represent each number as two hexadecimal digits (including a leading 
  ...
  characters of the hash would be 4007ff. Because every Knot Hash is 
  sixteen such numbers, the hexadecimal representation is always 32 
