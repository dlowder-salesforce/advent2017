...
def index_to_compare1(digits, i):
    return (i + 1) % len(digits)

def index_to_compare2(digits, i):
    return (i + len(digits)/2) % len(digits)

def solution(digits, index_function):
    sum = 0
    for i in range(len(digits)):
        j = index_function(digits, i)
...
print(solution(digits, index_to_compare1))
print(solution(digits, index_to_compare2))
